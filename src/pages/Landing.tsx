...
{mode !== "forgot" ? (
          ...
          <button disabled={busy} className="w-full rounded-xl px-3 py-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white hover:opacity-90 disabled:opacity-60">
